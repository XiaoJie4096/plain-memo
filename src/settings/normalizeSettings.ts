...
const LEGACY_DEFAULT_SIDEBAR_SUBTITLES = new Set([
	...
	String.fromCodePoint(0x57fa, 0x4e8e, 0x4b, 0x6e, 0x6f, 0x6d, 0x6f, 0x5f00, 0x53d1),
	String.fromCodePoint(0x57fa, 0x4e8e, 0x20, 0x4b, 0x6e, 0x6f, 0x6d, 0x6f, 0x20, 0x5f00, 0x53d1),
